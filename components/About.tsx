        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          <div>
            ...
            <p className="text-gray-700 leading-relaxed mb-6">
              جمعية أهلية مسجلة بالمركز الوطني لتنمية القطاع غير الربحي برقم (1234)، تسعى لتنمية المجتمع المحلي عبر برامج ومشاريع مستدامة تساهم في بناء مجتمع حيوي ومنتج.
            </p>
            <button
