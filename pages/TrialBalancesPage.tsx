...
import { TRIAL_BALANCES_DATA, DocumentTextIcon } from '../constants';

const TrialBalancesPage: React.FC = () => {
  return (
    <>
      <PageHeader title="موازين المراجعة" breadcrumb="الحوكمة / التقارير المالية / موازين المراجعة" />
          ...
          <div className="max-w-3xl mx-auto">
            <div className="text-center mb-12">
                ...
                <p className="text-gray-600 mt-4 max-w-2xl mx-auto">
                    يمكنكم الاطلاع على موازين المراجعة الدورية للجمعية.
                </p>
            </div>
            <ul className="space-y-4">
              {TRIAL_BALANCES_DATA.map((item, index) => (
...
export default TrialBalancesPage;
