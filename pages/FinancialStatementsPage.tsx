...
import { FINANCIAL_STATEMENTS_DATA, DocumentTextIcon } from '../constants';

const FinancialStatementsPage: React.FC = () => {
  return (
    <>
      <PageHeader title="القوائم المالية" breadcrumb="الحوكمة / التقارير المالية / القوائم المالية" />
          ...
          <div className="max-w-3xl mx-auto">
            <div className="text-center mb-12">
                ...
                <p className="text-gray-600 mt-4 max-w-2xl mx-auto">
                    يمكنكم الاطلاع على القوائم المالية المعتمدة للجمعية للأعوام السابقة.
                </p>
            </div>
            <ul className="space-y-4">
              {FINANCIAL_STATEMENTS_DATA.map((item, index) => (
