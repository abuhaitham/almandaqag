...
const GoalsPage: React.FC = () => {
    const goals = [
        "تعزيز الانتماء وتنمية الروابط الاجتماعية بين الأهالي.",
        "تلمس احتياجات المجتمع المحلي والتعبير عنها والمساهمة في تلبيتها بالشراكات المجتمعية.",
        "تحسين واقع المجتمع المحلي في العمل والسلوك الشخصي والمشاركة المجتمعية.",
        "الاستفادة من خبرات وطاقات أفراد المجتمع المحلي."
    ];
