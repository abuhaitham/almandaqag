...
import { QUARTERLY_REPORTS_DATA } from '../../constants';
import { DocumentTextIcon } from '../../constants';

const QuarterlyReportsPage: React.FC = () => {
  return (
    <>
      <PageHeader title="التقارير الربعية" breadcrumb="الحوكمة / التقارير المالية / التقارير الربعية" />
          ...
          <div className="max-w-3xl mx-auto">
            <div className="text-center mb-12">
                ...
                <p className="text-gray-600 mt-4 max-w-2xl mx-auto">
                    نقدم تقارير ربعية لمتابعة الأداء المالي للجمعية بشكل دوري وشفاف.
                </p>
            </div>
            <ul className="space-y-4">
              {QUARTERLY_REPORTS_DATA.map((item, index) => (
