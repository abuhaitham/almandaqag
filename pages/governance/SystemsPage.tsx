...
const SystemsPage: React.FC = () => {
  return (
    <>
      <PageHeader title="الأنظمة" breadcrumb="الحوكمة / الأنظمة" />
          ...
          <div className="max-w-3xl mx-auto">
            <div className="text-center mb-12">
                ...
                <p className="text-gray-600 mt-4 max-w-2xl mx-auto">
                    نلتزم بالأنظمة والتشريعات الوطنية التي تنظم عمل القطاع غير الربحي والعمل التطوعي.
                </p>
            </div>
            <ul className="space-y-4">
              {SYSTEMS_DATA.map((item, index) => (
