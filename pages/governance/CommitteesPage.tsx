...
import { COMMITTEES_DATA } from '../../constants';
import { DocumentTextIcon } from '../../constants';

const CommitteesPage: React.FC = () => {
  return (
    <>
      <PageHeader title="اللجان والمجالس" breadcrumb="الحوكمة / اللجان والمجالس الإشرافية" />
      <section className="py-20 bg-light">
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto">
            <div className="text-center mb-12">
                <h2 className="text-3xl md:text-4xl font-extrabold text-primary">
                    اللجان والمجالس الإشرافية
                </h2>
                <p className="text-gray-600 mt-4 max-w-2xl mx-auto">
                    تساهم اللجان المتخصصة والمجالس الإشرافية في ضمان سير العمل بكفاءة وفعالية وفقًا للوائح المعتمدة.
                </p>
            </div>
            <ul className="space-y-4">
              {COMMITTEES_DATA.map((item, index) => (
