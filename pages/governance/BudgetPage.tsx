...
const BudgetPage: React.FC = () => {
  return (
    <>
      <PageHeader title="الموازنة التقديرية" breadcrumb="الحوكمة / التقارير المالية / الموازنة التقديرية" />
          ...
          <div className="max-w-3xl mx-auto">
            <div className="text-center mb-12">
                ...
                <p className="text-gray-600 mt-4 max-w-2xl mx-auto">
                    نلتزم بالشفافية في إدارة مواردنا المالية. يمكنكم الاطلاع على الموازنة التقديرية للجمعية من خلال الرابط أدناه.
                </p>
            </div>
